...
export class LanguageManagementComponent implements OnInit, AfterViewChecked {
  ...
  languagesList: Signal<ILanguageEntity[]> = computed(() =>
  ...
  private selectTableRow(): void {
    if (this.languageBlock?.nativeElement && !this.isSelectedRow) {
      ...
      this.render.listen(
        this.languageBlock.nativeElement,
        'click',
        (e: Event) => {
          ...
          if (trg.tagName.toLocaleLowerCase() === 'td') {
            ...
            if (rw) {
              ...
              if (flag) {
                ...
                const selectId = Number.parseInt(
                  rw.dataset['languageId'] as string
                );
                ...
                if (this.selectedLanguage) {
                  if (this.removeLanguageBtn?.nativeElement) {
                    this.render.listen(
                      this.removeLanguageBtn.nativeElement,
                      'click',
                      () => {
